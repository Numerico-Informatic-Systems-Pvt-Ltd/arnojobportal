...
<!--<a href = "<?php echo $view['router']->generate('_logout_index') ?>">Logout</a>-->
...
<div class="container-fluid main_body_bg">
    ...
    <div class="col-lg-9 col-sm-9">
    	<div class="dashboard_bg">
        	<div class="page_wrap">
            	<div class="page_heading">Page Name</div>
                <div class="table_pad">
                    <table class="table table-striped" cellpadding="0" cellspacing="0">
                        <tr>
                            <th>Serial No.</th>
                            <th>Candadate Name</th>
                            <th>Id</th>
                            <th>jh</th>
                            <th>Action</th>
                            <th>Status</th>
                        ...
                        <tr>
                        	<td>1</td>
                            <td>Dibyendu Mitra</td>
                            <td>001</td>
                            <td>dgfsgeg</td>
                            <td><a href="#"><img src="<?php echo $view['assets']->getUrl('JobPortal/images/active.gif') ?>" alt="Active" class="img-responsive" /></a></td>
                            <td>
                            	<a href="#"><img src="<?php echo $view['assets']->getUrl('JobPortal/images/edit.png') ?>" alt="Edite" class="img-responsive" width="22" style="float:left; margin-right:8px;" /></a>
