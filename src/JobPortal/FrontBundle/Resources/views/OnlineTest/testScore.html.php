	...
	<div class="container">
        <div class="col-lg-12 col-sm-12 result_wrap">
            ...
            <div class="col-lg-9 col-sm-9">
                ...
                <div class="result">
                    <div class="info">
                        <p><strong>Nom du test</strong>: <?php echo $exam_name; ?></p>
                    </div>
                    ...
                    <div class="col-lg-12 less_pad">
                        ...
                        <div class="result_box_wrap">
                            <div class="col-lg-4 col-sm-4">
                                ...
                                <p><?php echo $correct_answer; ?> sur <?php echo $total_questions; ?></p>
                            </div>
                            <div class="col-lg-4 col-sm-4" style="border-left:1px solid #ccc; border-right:1px solid #ccc;">
                                <p><strong>Score</strong></p>
                                <p><?php echo $score; ?> sur <?php echo $total_marks; ?></p>
                            </div>
                            <div class="col-lg-4 col-sm-4">
                    ...
                    <div class="result_button_wrap">
                        <a href = "<?php echo $view['router']->generate('begin_test',  array('id' => $exam_id)) ?>"><input type="button" class="result_button" value="Faire des tests similaire >" />
                    </div>
